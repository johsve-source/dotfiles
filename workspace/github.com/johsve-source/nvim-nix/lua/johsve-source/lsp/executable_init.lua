require("johsve-source.lsp.config.marksman")
require("johsve-source.lsp.config.nixd")
require("johsve-source.lsp.config.lua_ls")
require("johsve-source.lsp.config.basedpyright")
require("johsve-source.lsp.config.rust_analyzer")
require("johsve-source.lsp.config.ts_ls")
require("johsve-source.lsp.config.zls")
